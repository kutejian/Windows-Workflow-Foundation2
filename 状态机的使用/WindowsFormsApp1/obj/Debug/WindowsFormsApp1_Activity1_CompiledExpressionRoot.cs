namespace WindowsFormsApp1 {
    ...
    #line 21 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 22 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    ...
    #line 23 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 24 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 25 "C:\Users\30765\Desktop\状态机的使用\WindowsFormsApp1\Activity1.xaml"
    using System.Text;
    ...
    public partial class Activity1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 0)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext3_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 3);
            ...
            if ((expressionId == 2)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext4.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 3);
                if ((cachedCompiledDataContext[1] == null)) {
                    cachedCompiledDataContext[1] = new Activity1_TypedDataContext4(locations, activityContext, true);
                }
                Activity1_TypedDataContext4 refDataContext2 = ((Activity1_TypedDataContext4)(cachedCompiledDataContext[1]));
            ...
            if ((expressionId == 3)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Activity1_TypedDataContext4_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 3);
                if ((cachedCompiledDataContext[2] == null)) {
                    cachedCompiledDataContext[2] = new Activity1_TypedDataContext4_ForReadOnly(locations, activityContext, true);
                }
                Activity1_TypedDataContext4_ForReadOnly valDataContext3 = ((Activity1_TypedDataContext4_ForReadOnly)(cachedCompiledDataContext[2]));
            ...
            if ((expressionId == 4)) {
                ...
                Activity1_TypedDataContext4_ForReadOnly valDataContext4 = ((Activity1_TypedDataContext4_ForReadOnly)(cachedCompiledDataContext[2]));
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.Location> locations) {
            ...
            if ((expressionId == 4)) {
                Activity1_TypedDataContext4_ForReadOnly valDataContext4 = new Activity1_TypedDataContext4_ForReadOnly(locations, true);
                return valDataContext4.ValueType___Expr4Get();
            }
            return null;
        }
        ...
        public System.Linq.Expressions.Expression GetExpressionTreeForExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences) {
            ...
            if ((expressionId == 4)) {
                return new Activity1_TypedDataContext4_ForReadOnly(locationReferences).@__Expr4GetTree();
            }
            return null;
        }
        ...
        private class Activity1_TypedDataContext3_ForReadOnly : Activity1_TypedDataContext2_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 60 "C:\USERS\30765\DESKTOP\状态机的使用\WINDOWSFORMSAPP1\ACTIVITY1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 55 "C:\USERS\30765\DESKTOP\状态机的使用\WINDOWSFORMSAPP1\ACTIVITY1.XAML"
        ...
        private class Activity1_TypedDataContext4 : Activity1_TypedDataContext2 {
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 73 "C:\USERS\30765\DESKTOP\状态机的使用\WINDOWSFORMSAPP1\ACTIVITY1.XAML"
        ...
        private class Activity1_TypedDataContext4_ForReadOnly : Activity1_TypedDataContext2_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 81 "C:\USERS\30765\DESKTOP\状态机的使用\WINDOWSFORMSAPP1\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<bool>> expression = () => 
                      A1==false;
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 86 "C:\USERS\30765\DESKTOP\状态机的使用\WINDOWSFORMSAPP1\ACTIVITY1.XAML"
                System.Linq.Expressions.Expression<System.Func<bool>> expression = () => 
                      A1==true;
